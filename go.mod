...
require (
	...
	github.com/MonikaCat/regen-ledger/types v1.0.0
	github.com/MonikaCat/regen-ledger/x/data v0.0.0-20211202162855-98bb2b15c314
	github.com/MonikaCat/regen-ledger/x/ecocredit v1.0.0
	github.com/MonikaCat/regen-ledger/x/group v1.0.0-beta1
...
require (
	...
	github.com/MonikaCat/regen-ledger/orm v1.0.0-beta1 // indirect
